    ...
    foreach( $linhas as $item )
    {
        ...
        $saida .= '    <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <p class="text-primary m-0 font-weight-bold">'. $item->nome . '</p>
                </div>
                <div class="card-body">
                ' . fhistorico( $idUsuarioP, $item->id ) . '
                    <form>
                        <div class="form-row">
                            <div class="col">
...
try {
  ...
  $saida = '<div class="overflow-auto">' . $saida . '</div>';

    $saida =  '                       <div class="form-row">
                            <div class="col">
                                ' . $saida . '
                            </div>
                        </div>';
...
<div>
    ...
    foreach( $etapas as $item ) { ?>
        <li class="nav-item" role="presentation">
            <a class="nav-link <?=$item->cor;?> <?=$ativo;?>" role="tab" data-toggle="tab" href="#tab-<?=$item->id;?>">
